<div id="tab-documentos" class="tab-content">
    <div class="section">
        <div class="section-header">
            <h3 class="section-title">Documentos del Cliente</h3>
            ...
            <table class="table">
                ...
                <tbody>
                    @forelse ($cliente->documentos as $documento)
                        @php
                            // Determinar el tipo de archivo basado en mime_type
                            $fileType = 'file';
                            ...
                            // Obtener el primer expediente asociado (si existe)
                            $expedienteAsociado = $documento->expedientes->first();
                        @endphp
                        <tr>
                            <td>
                            ...
                            <td>
                                @if($expedienteAsociado)
                                    <a href="{{ route('expedientes.show', $expedienteAsociado->id) }}" class="text-primary-400 font-medium hover:underline">
                                        {{ $expedienteAsociado->numero_expediente }}
                                    </a>
                                @else
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-8">
                                <div class="flex flex-col items-center gap-4">
                                    ...
                                    <p class="text-text-muted">No hay documentos registrados para este cliente</p>
                                    <button type="button" onclick="abrirModalSubirDocumento()" class="btn btn-primary">
                                        <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
@include('documentos.partials.modal-subir', ['contextoTipo' => 'cliente', 'contextoId' => $cliente->id])
